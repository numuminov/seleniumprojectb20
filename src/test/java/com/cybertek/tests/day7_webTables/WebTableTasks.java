...
public class WebTableTasks {
    ...
    public void p3_verify_susans_order_date(){
        ...
        String exp="01/05/2010";
        String act =susansDate.getText();
...
When you create a locator that returns more than one option, you have the freedom to pass index number to select which one you want to get.
    ...
    if they are not siblings: you must surround the whole locator with parenthesis (), then pass index number.
        (//div[@class='something'])[2]
        (//div[@class='something'])[3]
        (//div[@class='something'])[4]
